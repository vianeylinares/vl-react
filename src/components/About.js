...
export const About = () => {
  return (
    <>
      <Helmet>
        <title>Vianey Linares | WordPress Developer - About</title>
        <meta name="description" content="Full stack WordPress developer experienced in approaching diverse types of web projects. Also, fairly experienced in modifying and fixing websites." />
